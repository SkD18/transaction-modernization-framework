...
/**
 * AccountService is part of the Transaction-Modernization-Framework reference implementation.
...
public class AccountService {
    ...
    public AccountService(String name, int version) {
        this.name = name;
    ...
    public String processAccountServiceContext(String accountId, double delta) {
