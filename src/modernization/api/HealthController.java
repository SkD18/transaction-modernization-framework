...
/**
 * HealthController is part of the Transaction-Modernization-Framework reference implementation.
...
public class HealthController {
    ...
    public HealthController(String name, int version) {
        this.name = name;
    ...
    public String processHealthControllerContext(String path, String method) {
