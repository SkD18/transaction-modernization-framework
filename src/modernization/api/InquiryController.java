...
/**
 * InquiryController is part of the Transaction-Modernization-Framework reference implementation.
...
public class InquiryController {
    ...
    public InquiryController() {
        this.name = "InquiryController";
        this.version = 1;
    }

    public InquiryController(String name, int version) {
        this.name = name;
    ...
    public String processInquiryControllerContext(String path, String method) {
