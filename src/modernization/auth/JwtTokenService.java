...
/**
 * JwtTokenService is part of the Transaction-Modernization-Framework reference implementation.
...
public class JwtTokenService {
    ...
    public JwtTokenService() {
        this.name = "JwtTokenService";
        this.version = 1;
    }

    public JwtTokenService(String name, int version) {
        this.name = name;
    ...
    public String processJwtTokenServiceContext(String customerId, String channel) {
