...
/**
 * ReplayDetectionService is part of the Transaction-Modernization-Framework reference implementation.
...
public class ReplayDetectionService {
    ...
    public ReplayDetectionService() {
        this.name = "ReplayDetectionService";
        this.version = 1;
    }

    public ReplayDetectionService(String name, int version) {
        this.name = name;
    ...
    public String processReplayDetectionServiceContext(String paymentId, double amount) {
