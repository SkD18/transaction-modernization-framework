...
/**
 * Pacs002Builder is part of the Transaction-Modernization-Framework reference implementation.
...
public class Pacs002Builder {
    ...
    public Pacs002Builder() {
        this.name = "Pacs002Builder";
        this.version = 1;
    }

    public Pacs002Builder(String name, int version) {
        this.name = name;
    ...
    public String processPacs002BuilderContext(String msgId, String type) {
