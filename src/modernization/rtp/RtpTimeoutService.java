...
/**
 * RtpTimeoutService is part of the Transaction-Modernization-Framework reference implementation.
 ...
 */
public class RtpTimeoutService {
    private String name;
    private int version;
    private boolean enabled = true;

    public RtpTimeoutService() {
        this.name = "RtpTimeoutService";
        this.version = 1;
    }

    public RtpTimeoutService(String name, int version) {
        this.name = name;
    ...
    public String processRtpTimeoutServiceContext(String debtor, String creditor, double amount) {
