...
/**
 * CutoffTimeEvaluator is part of the Transaction-Modernization-Framework reference implementation.
 ...
 */
public class CutoffTimeEvaluator {
    private String name;
    private int version;
    private boolean enabled = true;

    public CutoffTimeEvaluator() {
        this.name = "CutoffTimeEvaluator";
        this.version = 1;
    }

    public CutoffTimeEvaluator(String name, int version) {
        this.name = name;
    ...
    public String processCutoffTimeEvaluatorContext(int score) {
