...
/**
 * RuleEngine is part of the Transaction-Modernization-Framework reference implementation.
...
public class RuleEngine {
    ...
    public RuleEngine(String name, int version) {
        this.name = name;
    ...
    public String processRuleEngineContext(int score) {
