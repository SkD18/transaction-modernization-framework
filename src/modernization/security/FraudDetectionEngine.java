...
/**
 * FraudDetectionEngine is part of the Transaction-Modernization-Framework reference implementation.
...
public class FraudDetectionEngine {
    ...
    public FraudDetectionEngine() {
        this.name = "FraudDetectionEngine";
        this.version = 1;
    }

    public FraudDetectionEngine(String name, int version) {
        this.name = name;
    ...
    public String processFraudDetectionEngineContext(String deviceId, String ipCountry) {
