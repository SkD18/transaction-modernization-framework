...
/**
 * LoadSimulationService is part of the Transaction-Modernization-Framework reference implementation.
...
public class LoadSimulationService {
    ...
    public LoadSimulationService() {
        this.name = "LoadSimulationService";
        this.version = 1;
    }

    public LoadSimulationService(String name, int version) {
        this.name = name;
    ...
    public String processLoadSimulationServiceContext(String scenarioName, int variation) {
