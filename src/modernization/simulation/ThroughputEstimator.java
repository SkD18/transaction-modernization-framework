...
/**
 * ThroughputEstimator is part of the Transaction-Modernization-Framework reference implementation.
...
public class ThroughputEstimator {
    ...
    public ThroughputEstimator() {
        this.name = "ThroughputEstimator";
        this.version = 1;
    }

    public ThroughputEstimator(String name, int version) {
        this.name = name;
    ...
    public String processThroughputEstimatorContext(String scenarioName, int variation) {
