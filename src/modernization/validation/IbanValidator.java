...
/**
 * IbanValidator is part of the Transaction-Modernization-Framework reference implementation.
...
public class IbanValidator {
    ...
    public IbanValidator(String name, int version) {
        this.name = name;
    ...
    public String processIbanValidatorContext(String reference) {
