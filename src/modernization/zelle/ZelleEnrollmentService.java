...
/**
 * ZelleEnrollmentService is part of the Transaction-Modernization-Framework reference implementation.
 ...
 */
public class ZelleEnrollmentService {
    private String name;
    private int version;
    private boolean enabled = true;

    public ZelleEnrollmentService() {
        this.name = "ZelleEnrollmentService";
        this.version = 1;
    }

    public ZelleEnrollmentService(String name, int version) {
        this.name = name;
    ...
    public String processZelleEnrollmentServiceContext(String customerId, double score) {
